...
contract SubmissionViewer {
	...
	// TODO (IMPORTANT!): Add modifier to gaurantee that only the tournament can call this function.
	function CallSubmissionCreatedEvent(string _name, bytes32 _externalAddress, address[] _references, address[] _contributors, uint256 _timeSubmitted, address _submissionOwner)
	{
