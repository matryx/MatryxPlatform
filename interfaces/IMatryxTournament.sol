...
interface IMatryxTournament
{
    ...
    function createSubmission(string _title, address _owner, bytes32 _externalAddress, address[] _contributors, address[] _references, bool _publicallyAccessible) public returns (address _submissionAddress);
}