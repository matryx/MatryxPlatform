...
interface IMatryxPeer
{
	...
	function receiveTrust(uint256 _newTotalTrust, uint256 _senderReputation) public;
	function receiveDistrust(uint256 _newTotalTrust, uint256 _senderReputation) public returns (bool);
